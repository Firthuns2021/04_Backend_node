...
//
const { getUsuarios, crearUsuario, actualizarUsuario, borrarUsuario } = require('../controllers/usuariosCtrl');
...
// 2º argumento son los middleware de validación de campos
router.post('/',
    [
